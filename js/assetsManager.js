...
AssetsManager.prototype.loadSounds = function() {
    this.audios["shieldUp"] = new Audio("assets/Bonus/sfx_shieldUp.wav");
    this.audios["shieldDown"] = new Audio("assets/Bonus/sfx_shieldDown.wav");
    this.audios["laserPlayer"] = new Audio("assets/Bonus/sfx_laser1.mp3");
    this.audios["laserEnemy"] = new Audio("assets/Bonus/sfx_laser2.wav");
